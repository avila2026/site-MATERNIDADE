...
const Checkout: React.FC<CheckoutProps> = ({ items, onBack }) => {
  ...
  return (
    <div className="min-h-screen pt-24 pb-24 px-6 bg-[#E0F2F1] animate-fade-in-up">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            <p className="text-sm text-[#5D5A53] mb-12">Este é um site de exemplo. A compra está desativada.</p>
            ...
            <div className="space-y-12">
              ...
              <div>
                ...
                <div className="space-y-4">
                   ...
                   <div className="flex items-center gap-2">
                     ...
                     <label htmlFor="newsletter" className="text-sm text-[#5D5A53] cursor-not-allowed">Enviar notícias e ofertas por e-mail</label>
                   </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                   ...
                   <input type="text" placeholder="Apartamento, suíte, etc. (opcional)" className="w-full bg-transparent border-b border-[#D6D1C7] py-3 text-[#2C2A26] placeholder-[#A8A29E] outline-none focus:border-[#2C2A26] transition-colors cursor-not-allowed" disabled />
                   <div className="grid grid-cols-2 gap-4">
