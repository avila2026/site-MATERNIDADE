...
const About: React.FC = () => {
  return (
    <section id="about" className="bg-[#FFF1F2]">
      
      {/* Introduction / Story */}
      <div className="py-24 px-6 md:px-12 max-w-[1800px] mx-auto flex flex-col md:flex-row items-start gap-16 md:gap-32">
        <div className="md:w-1/3">
          <h2 className="text-4xl md:text-6xl font-serif text-[#4C0519] leading-tight">
            Nascido do amor, <br/> construído para o cuidado.
          </h2>
        </div>
        <div className="md:w-2/3 max-w-2xl">
          <p className="text-lg md:text-xl text-[#881337] font-light leading-relaxed mb-8">
          ...
          />
          <p className="text-sm font-medium uppercase tracking-widest text-[#FDA4AF] mt-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
        ...
        <div className="order-1 lg:order-2 flex flex-col justify-center p-12 lg:p-24 bg-[#FFE4E6]">
           <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#881337] mb-6">Cuidado</span>
